...
Version: 1.0.0
Author: Slope Calculator / www.calculator.io
...
function display_calcio_ci_slope_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_slope_calculator', 'display_calcio_ci_slope_calculator' );